...
namespace Arap {
    ...
    double regularizeQuads(Lattice &lattice, PosTypeIndex dstPos);
    int regularizeLattice(Lattice &lattice, PosTypeIndex sourcePos, PosTypeIndex dstPos, int maxIterations, bool allGrid=false, bool convergenceStop=true);
